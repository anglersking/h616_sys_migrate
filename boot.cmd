...
setenv bootargs 'console=ttyS0,115200 console=tty0 video=HDMI-A-1:1920x1080@60D fbcon=map:0 root=/dev/mmcblk0p2 rootfstype=ext4 rootwait rw init=/sbin/init debug panic=30'
